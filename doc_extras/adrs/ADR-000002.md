# ADR-000002: Pluggable Tree Engine and Thicket — Balancing Interior-Node Load Across a Group's Trees
...
- **Default-off respects the gate.** Making Thicket per-group and opt-in keeps
  ...
  honours ADR-000001's "do not adopt until measured" position while still making
...
- **ADR-000001** — established the per-group broadcast architecture and factored
