...
start(Arg) ->
    partisan_gen_server:start(?MODULE, ok, Arg).
init(Args) ->
    partisan_gen_server_SUITE:init(Args).
handle_call(Call, From, State) ->
    partisan_gen_server_SUITE:handle_call(Call, From, State).
handle_cast(Cast, State) ->
    partisan_gen_server_SUITE:handle_cast(Cast, State).
handle_info(Info, State) ->
    partisan_gen_server_SUITE:handle_info(Info, State).
terminate(Reason, State) ->
    partisan_gen_server_SUITE:terminate(Reason, State).
